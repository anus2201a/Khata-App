...
<body
    style="background-image: url(admin/assets/images/logo/img.jpg); width: 100%; height: auto;">
    ...
    {{-- @if (session()->has('error')) --}}
            ...
            <div class="sign-up-text col-lg-6 pt-4 m-auto">
                ...
                <div class="sign-up-from col-lg-6 m-auto">
                    <div class="sign-up-from-item">
                        <div class="sign-up-from-inner">
                            ...
                            <div class="icon">
                                <i class="bi bi-eye-slash h4" id="togglePassword"></i>
                            </div>
                        </div>
                        ...
                        <div class="sign-up-from-inner">
                            ...
                            <div class="icon">
                                <i class="bi bi-eye-slash h4" id="togglePassword2">
                                    {{-- <span>
                        ...
                        <div class="sign-up-from-inner">
                            <input type="password" id="password3" name="password_confirmation" class="form-control" 
                                placeholder="Confirm Password">

                            <div class="icon">
                                <i class="bi bi-eye-slash h4" id="togglePassword3">
                                    {{-- <span>
                                        <svg width="22" height="20" viewBox="0 0 22 20" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path d="M2 1L20 19" stroke="#718096" stroke-width="1.5" stroke-linecap="round"
