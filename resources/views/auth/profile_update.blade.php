                                ...
                                <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                         ...
                                         <form action="{{route ('profile.update.store')}}" enctype="multipart/form-data" method="POST">
                                                @csrf

                                                @if (session()->has('success'))
                                                <div class="alert alert-warning alert-dismissible fade show col col-12 col-md-12 col-lg-6 text-center m-auto" role="alert">
                                                    ...
                                                    <div class="personal-informations-from-item">
                                                        ...
                                                        <div class="personal-informations-from-item-inner">
                                                            {{-- <div class="row"> --}}
                                                                ...
                                                                {{-- <div class="col col-12 col-md-12 col-lg-6 m-auto pt-2">
                                                                    <label for="exampleFormControlInput1"
                                                                        class="form-label last-name">User Type
                                                                        </label>
                                                                    <input type="text"  name="section_2_main_decs" class="form-control"
