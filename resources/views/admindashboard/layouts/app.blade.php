...
<body>
    <div class="body-bg">
        ...
        <a href="index-2.html">
          <img class="nftmax-logo__main" src="{{asset('admin/assets/bootstrap.min.css')}}/images/logo/Logo-dark.png" alt="logo">

        </a>

        <div class="logo-two">
          <img src="{{asset('admin/assets/bootstrap.min.css')}}/images/logo/logo-shape-dark.png" alt="img">
        </div>
        <div class="nftmax__sicon close-icon">
          <span>
                ...
                {{-- <div class="admin-menu__one admin-menu__two">
                    ...
                    <div class="menu-bar">
                        <ul class="sidebar_nav">
                            ...
                            <li class="menu-main">
                                <a href="{{ route('generate', 'Category') }}">
                                    <div class="has-child-main">
                                        <div class="has-child-main-inner">
                                            <div class="has-child-icon mt-1">
                                                <span>
                ...
                {{-- <div class="admin-menu__one admin-menu__two">
                    ...
                    <div class="menu-bar">
                        <ul class="sidebar_nav">
                            ...
                            <li class="menu-main">
                                <a href="{{ route('service-faqs.view') }}">
                                    <div class="has-child-main">
                                        <div class="has-child-main-inner">
                                            <div class="has-child-icon">
                                                <span>
