                                ...
                                <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                         ...
                                         <form action="{{route('platform.update-store', $update_platform->id)}}" enctype="multipart/form-data" method="POST">
                                                @csrf
                                                    ...
                                                    <div class="personal-informations-from-item-inner">
                                                        <div class="row">
                                                            <div class="col-12 col-md-12  col-lg-6">
                                                                ...
                                                                <input type="text" value="{{$update_platform->name}}" name="name" class="form-control"
                                                                    aria-label="Last name">
                                                            </div>
                                                            <div class="col-12 col-md-12  col-lg-6">
                                                                <label for="exampleFormControlInput1"
                                                                    class="form-label last-name ">Profession</label>
                                                                <input type="text" name="description" value="{{$update_platform->description}}" class="form-control"
                                                                    aria-label="Last name">
                                                            </div>
                                                        </div>
                                                    </div>
