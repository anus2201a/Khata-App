                                    ...
                                    <div class="col-lg-12">
                                        <div class="row border border-5 border-dark m-auto py-2">
                                            <div class="personal-informations-from-btn col-lg-6 m-auto">
                                                <h1 align="left"><b>Update Category</b></h1>
                                            </div>
                                        ...
                                        <form action="{{ url('dashboard/category/update/' . $update_category->id) }}" enctype="multipart/form-data" method="POST">
                                            @csrf
                                                    ...
                                                    <div class="personal-informations-from-item-inner">
                                                        <div class="row">
                                                            <div class="col-12 col-md-12 col-lg-12">
                                                                ...
                                                                <input type="text" value="{{$update_category->name}}" name="name"
