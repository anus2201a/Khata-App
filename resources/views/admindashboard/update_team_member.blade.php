                                ...
                                <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                         ...
                                         <form action="{{route ('team.update.store' , $update_team->id)}}" enctype="multipart/form-data" method="POST">
                                                @csrf
                                                    ...
                                                    <div class="personal-informations-from-item-inner">
                                                        <div class="row">
                                                            <div class="col-12 col-md-12  col-lg-6">
                                                                ...
                                                                <input type="text" value="{{$update_team->name}}" name="name" class="form-control"
                                                                    aria-label="Last name">
                                                            </div>
                                                            <div class="col-12 col-md-12  col-lg-6">
                                                                <label for="exampleFormControlInput1"
                                                                    class="form-label last-name ">Profession</label>
                                                                <input type="text" name="profession" value="{{$update_team->profession}}" class="form-control"
                                                                    aria-label="Last name">
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="col-12 col-md-12 col-lg-12 mt-2">
                                                                ...
                                                                <input type="file" name="image" class="form-control"
                                                                    ...
                                                                    {{-- <div class="payment-item "> --}}
                                                                        ...
                                                                        <br>
                                                                        <img src="{{asset($update_team->img)}}" style="border-radius: 10px;"  width="170" height="auto" alt="">
                                                                    {{-- </div> --}}
