                                    ...
                                    <div class="col-lg-12">
                                        <div class="row border border-5 border-dark m-auto py-2">
                                            <div class="personal-informations-from-btn col-lg-6 m-auto">
                                                <h1 align="left"><b>Contact Page</b></h1>
                                            </div>
                                                    ...
                                                    <div class="personal-informations-from-item-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12 col-md-12 col-lg-6">
                                                                ...
                                                                <input type="text" value="{{ get_cms('section_1_main_tittle','contact','value') }}"
                                                                    name="section_1_main_tittle" class="form-control"
                                                            ...
                                                            <div class="col col-12 col-md-12 col-lg-6 ">
                                                                ...
                                                                <input type="file" name="section_1_main_image"
                                                                    class="form-control" aria-label="Email">
                                                                <br>
                                                                <img src="{{asset(get_cms('section_1_main_image','contact','value'))}}" style="border-radius: 10px;"
                                                                    width="170" height="auto" alt="">
                                                        ...
                                                        <div class="personal-informations-from-item-inner">
                                                            <div class="row ">
                                                                <div class="col col-12 col-md-12 col-lg-6 ">
                                                                    ...
                                                                    <input type="text"
                                                                        value="{{get_cms('section_2_tittle_1','contact','value')}}" name="section_2_tittle_1"
                                                                        class="form-control" aria-label="Email">
                                                                </div>
                                                                <div class="col col-12 col-md-12 col-lg-6">
                                                                    <label for="exampleFormControlInput1"
                                                                    ...
                                                                    <input type="text" value="{{get_cms('section_2_decs_1','contact','value')}}"
                                                                        name="section_2_decs_1" class="form-control"
                                                        ...
                                                        <div class="personal-informations-from-item-inner">
                                                            <div class="row ">
                                                                <div class="col col-12 col-md-12 col-lg-6 ">
                                                                    ...
                                                                    <input type="file" name="section_2_image_1"
                                                                        class="form-control" aria-label="Email">
                                                                    <br>
                                                                    <img src="{{asset(get_cms('section_2_image_1','contact','value'))}}"
                                                                        style="border-radius: 10px;" width="170"
                                                                        height="auto" alt="">
                                                        ...
                                                        <div class="personal-informations-from-item-inner">
                                                            <div class="row ">
                                                                <div class="col col-12 col-md-12 col-lg-6 ">
                                                                    ...
                                                                    <input type="text"
                                                                        value="{{get_cms('section_2_tittle_2','contact','value')}}" name="section_2_tittle_2"
                                                                        class="form-control" aria-label="Email">
                                                                </div>
                                                                <div class="col col-12 col-md-12 col-lg-6">
                                                                    <label for="exampleFormControlInput1"
                                                                    ...
                                                                    <input type="text" value="{{get_cms('section_2_decs_2','contact','value')}}"
                                                                        name="section_2_decs_2" class="form-control"
                                                                        aria-label="Phone Number (Optional)">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="personal-informations-from-item-inner">
                                                            <div class="row ">
                                                                <div class="col col-12 col-md-12 col-lg-6 ">
                                                                    ...
                                                                    <input type="file" name="section_2_image_2"
                                                                        class="form-control" aria-label="Email">
                                                                    <br>
                                                                    <img src="{{asset(get_cms('section_2_image_2','contact','value'))}}"
                                                                        style="border-radius: 10px;" width="170"
                                                                        height="auto" alt="">
                                                        ...
                                                        <div class="personal-informations-from-item-inner">
                                                            <div class="row ">
                                                                <div class="col col-12 col-md-12 col-lg-6 ">
                                                                    ...
                                                                    <input type="text"
                                                                        value="{{get_cms('section_2_tittle_3','contact','value')}}" name="section_2_tittle_3"
                                                                        class="form-control" aria-label="Email">
                                                                </div>
                                                                <div class="col col-12 col-md-12 col-lg-6">
                                                                    <label for="exampleFormControlInput1"
                                                                    ...
                                                                    <input type="text" value="{{get_cms('section_2_decs_3','contact','value')}}"
                                                                        name="section_2_decs_3" class="form-control"
                                                                        aria-label="Phone Number (Optional)">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="personal-informations-from-item-inner">
                                                            <div class="row ">
                                                                <div class="col col-12 col-md-12 col-lg-6 ">
                                                                    ...
                                                                    <input type="file" name="section_2_image_3"
                                                                        class="form-control" aria-label="Email">
                                                                    <br>
                                                                    <img src="{{asset(get_cms('section_2_image_3','contact','value'))}}"
                                                                        style="border-radius: 10px;" width="170"
                                                                        height="auto" alt="">
                                                        ...
                                                        <div class="personal-informations-from-item-inner">
                                                            <div class="row  ">
                                                                <div class="col-12 col-md-12 col-lg-6 ">
                                                                    ...
                                                                    <input type="text"
                                                                        value="{{get_cms('section_3_main_tittle','contact','value')}}"
                                                                        name="section_3_main_tittle"
                                                                ...
                                                                <div class="col-12 col-md-12  col-lg-6">
                                                                    ...
                                                                    <input type="text"
                                                                        value="{{get_cms('section_3_main_desc','contact','value')}}"
                                                                        name="section_3_main_desc" class="form-control"
                                                            ...
                                                            <div class="row  ">
                                                                <div class="col-12 col-md-12 col-lg-6 ">
                                                                    <label for="exampleFormControlInput1"
                                                                        class="form-label">Main Image</label>
                                                                    <input type="file"
                                                                        value="{{get_cms('section_3_main_image','contact','value')}}"
                                                                        name="section_3_main_image"
                                                                        class="form-control " aria-label="First name"><br>
                                                            ...
                                                            <div class="row  ">
                                                                <div class="col-12 col-md-12 col-lg-6 ">
                                                                    <label for="exampleFormControlInput1"
                                                                        class="form-label">Main Tittle</label>
                                                                    <input type="text"
                                                                        value="{{get_cms('section_4_main_tittle','contact','value')}}"
                                                                        name="section_4_main_tittle"
                                                                        class="form-control   " aria-label="First name">
                                                                </div>
                                                                <div class="col-12 col-md-12  col-lg-6">
                                                                    <label for="exampleFormControlInput1"
                                                                    ...
                                                                    <input type="text"
                                                                        value="{{get_cms('section_4_main_desc','contact','value')}}"
                                                                        name="section_4_main_desc" class="form-control"
                                                                        aria-label="Last name"><br>
                                                                </div>
                                                            </div>
                                                        </div>
