                                        ...
                                        {{-- <div class="container-fluid"> --}}
                                            <div class="card m-auto p-auto">
                                                <div class="card-header col-lg-12 d-flex justify-content-between align-items-center">
                                                    <h4 class="card-title col-lg-10">All Category</h4>
                                                    {{-- <button type="submit" ">Add Member</button> --}}
                                                    <a href="{{route('category.add')}}" class="btn-one success text-white pt-3">Add Category</a>
                                                </div>
                                                        ...
                                                        @foreach ($data as $service)
                                                            <tr>
                                                                ...
                                                                <td class="col-lg-2">
                                                                    ...
                                                                    <a href="{{route('category.update' , $service->id )}}" class="btn-one success text-white pt-3">Update</a><br>
                                                                    <a href="{{route('category.delete', $service->id)}}" class="btn-one danger bg-danger text-white pt-3">Delete</a>
                                                                </div></td>
                                                            </tr>
                                                        @endforeach
                                                    </tbody>
