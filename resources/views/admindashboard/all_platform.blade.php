                                    ...
                                    <div class="col-lg-12">
                                        <div class="row border border-3 border-dark m-auto py-2">
                                            <div class="personal-informations-from-btn col-lg-6 m-auto">
                                                <h2 align="left"><b>Platforms </b></h2>
                                            </div>
                                        ...
                                        {{-- <div class="container-fluid"> --}}
                                            <div class="card m-auto p-auto">
                                                <div class="card-header col-lg-12 d-flex justify-content-between align-items-center">
                                                    <h4 class="card-title col-lg-10">All Platform</h4>
                                                    {{-- <button type="submit" ">Add Member</button> --}}
                                                    <a href="{{route('platform.add')}}" class="btn-one success text-white pt-3">Add Platform</a>
                                                </div>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="col-lg-2">
                                                                    <div class="col-lg-12 d-flex">
                                                                        <a href="{{route('platform.update', $platform->id )}}" class="btn-one success text-white pt-3">Update</a><br>
                                                                        <a href="{{route('platform.delete', $platform->id)}}" class="btn-one danger bg-danger text-white pt-3">Delete</a>
                                                                </div></td>
                                                            </tr>
                                                        @endforeach
                                                    </tbody>
