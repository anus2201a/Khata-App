            ...
            <div class="total-earnings">
              <div class="total-earnings-main">
                <div class="sub-earnings">
                  <div class="icon">
                    <img src="admin/assets/images/icon/total.png" alt="icon">
                  </div>
                  <div class="text">
                ...
                <div class="sub-earnings-user">
                  <img src="admin/assets/images/icon/user.png" alt="img">
                </div>
              </div>
          ...
          <div class="col-lg-4 col-md-6 col-responsive-padd-top-20px">
            <div class="total-earnings">
              <div class="total-earnings-main">
                <div class="sub-earnings">
                  <div class="icon">
                    <img src="admin/assets/images/icon/total-1.png" alt="icon">
                  </div>
                  <div class="text">
              ...
              <div class="tabel-search-box-item">
                ...
                <div class="tabel-search-box-button">
                  <div class="tabel-search-box-button-img">
                    <img src="admin/assets/images/icon/filter.svg" alt="img">
                  </div>
                  <div class="dropdown">
              ...
              <div class="list-btn">
                <div class="dropdown">
                  <button class="btn dropdown-toggle" type="button" id="dropdownMenuButton2" data-bs-toggle="dropdown"
                    ...
                    <span class="btn-img">
                      <img src="admin/assets/images/icon/chevron-down.png" alt="img">
                    </span>
                  </button>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <div class="tabel-item">
                        <div class="tabel-img">
                          <img src="admin/assets/images/tabel-1.png" alt="img">
                        </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="tabel-item">
                        <div class="tabel-img">
                          <img src="admin/assets/images/tabel-2.png" alt="img">
                        </div>
                        <div class="tabel-text">
                          <p>Bessie Cooper</p>
                        </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="tabel-item">
                        <div class="tabel-img">
                          <img src="admin/assets/images/tabel-3.png" alt="img">
                        </div>
                        <div class="tabel-text">
                          <p>Dianne Russell</p>
                        </div>
            ...
            <div class="my-walet-item-box">
              ...
              <div class="my-walet-item-box-img-slick">
                <div class="my-walet-item-box-img">
                  <img src="admin/assets/images/card-1.svg" class="w-100" alt="img">
                </div>
                <div class="my-walet-item-box-img">
                  <img src="admin/assets/images/card-2.svg" class="w-100" alt="img">
                </div>
                <div class="my-walet-item-box-img">
                  <img src="admin/assets/images/card-3.svg" class="w-100" alt="img">
                </div>
              </div>
              ...
              <div class="quick-transfr">
                ...
                <div class="btn-two">
                  ...
                  <div class="btn-main">
                    ...
                    <div class="btn-img">
                      <img src="admin/assets/images/recipient.png" alt="img">
                    </div>
                  </div>
                </div>
          ...
          <div class="team-chat">
            <div class="team-chat-head">
              <div class="team-chat-head-item">
                ...
                <div class="left">
                  <img src="admin/assets/images/member.png" alt="img">
                  <button class="btn" type="button">
                    <span>
                      <img src="admin/assets/images/icon/plus.png" alt="img">
                    </span>
                  </button>
                </div>
              </div>
            ...
            <div class="team-chat-item">
              <div class="team-chat-item-inner">
                <div class="team-chat-item-inner-img">
                  <img src="admin/assets/images/user-1.png" alt="img">
                </div>
              ...
              <div class="team-chat-item-inner">
                ...
                <div class="team-chat-item-inner-text">
                  <img src="admin/assets/images/mp3.png" class="img-fluid" alt="img">
                  <h6>10:00 PM</h6>
                </div>
              </div>
              <div class="team-chat-item-inner">
