                                                        ...
                                                        <div class="row">
                                                            <div class="col-12 col-md-12 col-lg-12 ">
                                                                <label for="exampleFormControlInput1"
                                                                    class="form-label">White Logo</label>
                                                                    <input type="file" name="logo-white" class="form-control"
                                                                    ...
                                                                    {{-- <div class="payment-item "> --}}
                                                                        ...
                                                                        <img src="{{asset(get_cms('logo-white','logo-favicon','value'))}}" class="bg-light" style="border-radius: 10px;"  width="100" height="auto" alt="">
                                                                    {{-- </div> --}}
                                                ...
                                                <div class="personal-informations-from-item">
                                                    ...
                                                    <div class="personal-informations-from-item-inner">
                                                        <div class="row">
                                                            <div class="col-12 col-md-12 col-lg-12 ">
                                                                <label for="exampleFormControlInput1"
                                                                    class="form-label">Black Logo</label>
                                                                    <input type="file" name="logo-black" class="form-control"
                                                                    aria-label="First name">
                                                                    {{-- <div class="payment-item "> --}}
                                                                        ...
                                                                        <img src="{{asset(get_cms('logo-black','logo-favicon','value'))}}" style="border-radius: 10px;"  width="100" height="auto" alt="">
                                                                    {{-- </div> --}}
                                                            ...
                                                            <div class="col-12 col-md-12 col-lg-12 ">
                                                                ...
                                                                <input type="file" name="favicon" class="form-control"
                                                                    ...
                                                                    {{-- <div class="payment-item "> --}}
                                                                        ...
                                                                        {{-- <div class="payment-text"> --}}
                                                                        <br>
                                                                        <img src="{{asset(get_cms('favicon','logo-favicon','value'))}}" style="border-radius: 10px;"  width="auto" height="auto" alt="favicon">
                                                                    {{-- </div> --}}
