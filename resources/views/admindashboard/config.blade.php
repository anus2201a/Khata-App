                                                ...
                                                <div class="personal-informations-from-item">
                                                    ...
                                                    <div class="personal-informations-from-item-inner">
                                                        {{-- <div class="row"> --}}
                                                            <div class="col-12 col-md-12  col-lg-12">
                                                                ...
                                                                <input type="text" value="{{get_cms('contact_number','config','value')}}" name="contact_number" class="form-control"
                                                    ...
                                                    <div class="personal-informations-from-item-inner">
                                                        <div class="row ">
                                                            <div class="col-12 col-md-12 col-lg-12 mt-2">
                                                                ...
                                                                <input type="text"value="{{get_cms('email_address','config','value')}}"  name="email_address" class="form-control"
                                                    ...
                                                    <div class="personal-informations-from-item-inner">
                                                        <div class="row ">
                                                            <div class="col-12 col-md-12 col-lg-12 mt-2">
                                                                ...
                                                                <input type="text" value="{{get_cms('address','config','value')}}" name="address" class="form-control"
                                                                    aria-label="First name">
                                                                     <br>
                                                    ...
                                                    <div class="personal-informations-from-item-inner">
                                                        <div class="row ">
                                                            <div class="col-12 col-md-12 col-lg-12 mt-2">
                                                                ...
                                                                <input type="text"value="{{get_cms('facebook_link','config','value')}}"  name="facebook_link" class="form-control"
                                                                    aria-label="First name">
                                                                     <br>
                                                    ...
                                                    <div class="personal-informations-from-item-inner">
                                                        <div class="row ">
                                                            <div class="col-12 col-md-12 col-lg-12 mt-2">
                                                                ...
                                                                <input type="text"value="{{get_cms('instagram_link','config','value')}}"  name="instagram_link" class="form-control"
                                                                    aria-label="First name">
                                                                     <br>
                                                    ...
                                                    <div class="personal-informations-from-item-inner">
                                                        <div class="row ">
                                                            <div class="col-12 col-md-12 col-lg-12 mt-2">
                                                                ...
                                                                <input type="text"value="{{get_cms('youtube_link','config','value')}}" name="youtube_link" class="form-control"
                                                                    aria-label="First name">
                                                                     <br>
                                                    ...
                                                    <div class="personal-informations-from-item-inner">
                                                        <div class="row ">
                                                            <div class="col-12 col-md-12 col-lg-12 mt-2">
                                                                ...
                                                                <input type="text"value="{{get_cms('twitter_link','config','value')}}"  name="twitter_link" class="form-control"
                                                                    aria-label="First name">
                                                                     <br>
                                                    ...
                                                    <div class="personal-informations-from-item-inner">
                                                        <div class="row ">
                                                            <div class="col-12 col-md-12 col-lg-12 mt-2">
                                                                <label for="exampleFormControlInput1"
                                                                    class="form-label">Tiktok Link</label>
                                                                <input type="text"value="{{get_cms('tiktok_link','config','value')}}"  name="tiktok_link" class="form-control"
                                                                    aria-label="First name">
                                                                     <br>
                                                    ...
                                                    <div class="personal-informations-from-item-inner">
                                                        <div class="row ">
                                                            <div class="col-12 col-md-12 col-lg-12 mt-2">
                                                                ...
                                                                <input type="text"value="{{get_cms('copy_right','config','value')}}"  name="copy_right" class="form-control"
                                                                    aria-label="First name">
                                                                     <br>
