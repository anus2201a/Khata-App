                                    ...
                                    <div class="col-lg-12">
                                        <div class="row border border-5 border-dark m-auto py-2">
                                            <div class="personal-informations-from-btn col-lg-6 m-auto">
                                                <h1 align="left"><b>Career Page</b></h1>
                                            </div>
                                        ...
                                        <form action="{{ route('update-cms') }}" enctype="multipart/form-data"
                                            ...
                                            <div class="personal-informations-from">
                                                    ...
                                                    <div class="personal-informations-from-item-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12 col-md-12 col-lg-6">
                                                                ...
                                                                <input type="text" value="{{get_cms('section_1_main_tittle','career','value')}}"
                                                            ...
                                                            <div class="col-12 col-md-12  col-lg-6">
                                                                ...
                                                                <input type="text" value="{{get_cms('section_1_main_desc','career','value')}}"
                                                                    name="section_1_main_desc" class="form-control"
                                                                    aria-label="Last name">
                                                            </div>
                                                    ...
                                                    <div class="personal-informations-from-item-inner">
                                                        <div class="row ">
                                                            <div class="col col-12 col-md-12 col-lg-6 ">
                                                                ...
                                                                <input type="file" name="section_1_image_1"
                                                                    class="form-control" aria-label="Email">
                                                                <br>
                                                                <img src="{{asset(get_cms('section_1_image_1','career','value'))}}" style="border-radius: 10px;"
                                                            ...
                                                            <div class="col col-12 col-md-12 col-lg-6">
                                                                ...
                                                                <input type="file" value=""
                                                                    name="section_1_image_2" class="form-control"
                                                                    aria-label="Phone Number (Optional)">
                                                                <br>
                                                                <img src="{{asset(get_cms('section_1_image_2','career','value'))}}" style="border-radius: 10px;"
                                                                    width="170" height="auto" alt="">
                                                    ...
                                                    <div class="personal-informations-from-item-inner">
                                                        <div class="row ">
                                                            <div class="col col-12 col-md-12 col-lg-6 ">
                                                                ...
                                                                <input type="file" name="section_1_image_3"
                                                                    class="form-control" aria-label="Email">
                                                                <br>
                                                                <img src="{{asset(get_cms('section_1_image_3','career','value'))}}" style="border-radius: 10px;"
                                                                    width="170" height="auto" alt="">
                                                            ...
                                                            <div class="col col-12 col-md-12 col-lg-6">
                                                                <label for="exampleFormControlInput1"
                                                                    class="form-label last-name">Image 4
                                                                </label>
                                                                <input type="file" value=""
                                                                    name="section_1_image_4" class="form-control"
                                                                    aria-label="Phone Number (Optional)">
                                                                <br>
                                                                <img src="{{asset(get_cms('section_1_image_4','career','value'))}}" style="border-radius: 10px;"
                                                                    width="170" height="auto" alt="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="personal-informations-from-item-inner">
                                                            <div class="row ">
                                                                <div class="col col-12 col-md-12 col-lg-6 ">
                                                                    ...
                                                                    <input type="text"
                                                                        value="{{get_cms('section_2_main_tittle','career','value')}}" name="section_2_main_tittle"
                                                                        class="form-control" aria-label="Email">
                                                                </div>
                                                                <div class="col col-12 col-md-12 col-lg-6">
                                                                    <label for="exampleFormControlInput1"
                                                                    ...
                                                                    <input type="text" value="{{get_cms('section_2_main_decs','career','value')}}"
                                                                        name="section_2_main_decs" class="form-control"
                                                                        aria-label="Phone Number (Optional)">
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="row ">
                                                                <div class="col col-12 col-md-12 col-lg-6 ">
                                                                    ...
                                                                    <input type="file" name="section_2_image_1"
                                                                        class="form-control" aria-label="Email">
                                                                    <br>
                                                                    <img src="{{asset(get_cms('section_2_image_1','career','value'))}}"
                                                            ...
                                                            <div class="row  ">
                                                                <div class="col-12 col-md-12 col-lg-6 ">
                                                                    <label for="exampleFormControlInput1"
                                                                        class="form-label">Main Tittle</label>
                                                                    <input type="text"
                                                                        value="{{get_cms('section_3_main_tittle','career','value')}}"
                                                                ...
                                                                <div class="col-12 col-md-12  col-lg-6">
                                                                    ...
                                                                    <input type="text"
                                                                        value="{{get_cms('section_3_main_desc','career','value')}}"
                                                ...
                                                <div class="personal-informations-from-btn">
                                                    <input type="hidden" name="tag" value="career">
