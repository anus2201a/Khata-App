                                        ...
                                        {{-- <div class="container-fluid"> --}}
                                            <div class="card m-auto p-auto">
                                                <div class="card-header col-lg-12 d-flex justify-content-between align-items-center">
                                                    <h4 class="card-title col-lg-10">All Services</h4>
                                                    {{-- <button type="submit" ">Add Member</button> --}}
                                                    <a href="{{route('service.add')}}" class="btn-one success text-white pt-3">Add Services</a>
                                                </div>
                                                    ...
                                                    <tbody>
                                                        @foreach ($data as $service)
                                                            <tr>
                                                                ...
                                                                <td><img src="{{ asset($service->image) }}" width="200" height='auto' alt="Image">
                                                                </td>

                                                                <td>{{ $service->get_category->name }}</td>
                                                                <td>{{ $service->overview }}</td>
                                                                <td class="col-lg-2">
                                                                    <div class="col-lg-12 d-flex">
                                                                    <a href="{{route('service.update', $service->id )}}" class="btn-one success text-white pt-3">Update</a><br>
                                                                    <a href="{{route('service.delete', $service->id)}}" class="btn-one danger bg-danger text-white pt-3">Delete</a>
                                                                </div></td>
                                                            </tr>
                                                        @endforeach
                                                    </tbody>
