                                                    ...
                                                    <div class="personal-informations-from-item-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12 col-md-12  col-lg-6">
                                                                ...
                                                                <input type="text" value="{{get_cms('section_1_main_tittle','service','value')}}" name="section_1_main_tittle" class="form-control"
                                                            ...
                                                            <div class="col-12 col-md-12 col-lg-6 ">
                                                                ...
                                                                <input type="file" name="section_1_main_image" class="form-control"
                                                                    ...
                                                                    {{-- <div class="payment-item "> --}}
                                                                        ...
                                                                        <br>
                                                                        <img src="{{asset(get_cms('section_1_main_image','service','value'))}}" style="border-radius: 12px;"  width="200" height="150" alt="">
                                                                    {{-- </div> --}}
                                                        ...
                                                        <div class="personal-informations-from-item-inner">
                                                            <div class="row ">
                                                                <div class="col col-12 col-md-12 col-lg-6 ">
                                                                    ...
                                                                    <input type="text" value="{{get_cms('section_2_main_tittle','service','value')}}" name="section_2_main_tittle" class="form-control"
                                                                        aria-label="Email">
                                                                </div>
                                                                <div class="col col-12 col-md-12 col-lg-6 ">
                                                                    <label for="exampleFormControlInput1"
                                                                        class="form-label">Background Image</label>
                                                                    <input type="file"  name="section_2_bg_image" class="form-control"
                                                                        aria-label="Email">
                                                                        <br>
                                                                        <img src=" {{asset(get_cms('section_2_bg_image','service','value'))}}" style="border-radius: 12px;"  width="200" height="auto" alt="">
                                                        ...
                                                        <div class="personal-informations-from-item-inner">
                                                            <div class="row ">
                                                                <div class="col col-12 col-md-12 col-lg-6">
                                                                    ...
                                                                    <input type="text" value="{{get_cms('section_2_tittle_1','service','value')}}" name="section_2_tittle_1" class="form-control"
                                                            ...
                                                            <div class="row ">
                                                                <div class="col col-12 col-md-12 col-lg-6 ">
                                                                    ...
                                                                    <input type="file" name="section_3_bg_image" class="form-control"
                                                                        aria-label="Email"><br>
                                                                       <img src=" {{asset(get_cms('section_3_bg_image','service','value'))}}" style="border-radius: 10px;"  width="auto" height="150" alt="">
                                                                ...
                                                                <div class="col col-12 col-md-12 col-lg-6 ">
                                                                    ...
                                                                    <input type="file" name="section_3_image_1" class="form-control"
                                                                        aria-label="Email"><br>
                                                                       <img src="{{asset(get_cms('section_3_image_1','service','value'))}}" style="border-radius: 10px;"  width="auto" height="150" alt="">
                                                            ...
                                                            <div class="row ">
                                                                <div class="col col-12 col-md-12 col-lg-6 ">
                                                                    ...
                                                                    <input type="file" name="section_3_image_2" class="form-control"
                                                                        aria-label="Email"><br>
                                                                       <img src="{{asset(get_cms('section_3_image_2','service','value')) }}" style="border-radius: 10px;"  width="auto" height="150" alt="">
                                                                ...
                                                                <div class="col col-12 col-md-12 col-lg-6">
                                                                    ...
                                                                    <input type="text" value="{{get_cms('section_3_main_tittle','service','value')}}" name="section_3_main_tittle" class="form-control"
                                                                        aria-label="Phone Number (Optional)">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="personal-informations-from-item-inner">
                                                            <div class="row ">
                                                                <div class="col col-12 col-md-12 col-lg-6 ">
                                                                    ...
                                                                    <input type="text" value="{{get_cms('section_3_main_desc','service','value')}}" name="section_3_main_desc" class="form-control"
                                                                        aria-label="Email">
                                                                        <br>
                                                        ...
                                                        <div class="personal-informations-from-item-inner">
                                                            <div class="row ">
                                                                <div class="col col-12 col-md-12 col-lg-6">
                                                                    ...
                                                                    <input type="text" value="{{get_cms('section_4_main_tittle','service','value')}}" name="section_4_main_tittle" class="form-control"
                                                                        aria-label="Phone Number (Optional)">
                                                                </div>
                                                                <div class="col col-12 col-md-12 col-lg-6 ">
                                                                    <label for="exampleFormControlInput1"
                                                                        class="form-label" >Main Description </label>
                                                                    <input type="text" value="{{get_cms('section_4_main_desc','service','value')}}" name="section_4_main_desc" class="form-control"
                                                                        aria-label="Email">
                                                                        <br>
                                                                        {{-- <img src="" style="border-radius: 10px;"  width="170" height="200" alt=""> --}}
                                                                </div>
                                                        ...
                                                        <div class="personal-informations-from-item-inner">
                                                            <div class="row ">
                                                                <div class="col col-12 col-md-12 col-lg-6 ">
                                                                    ...
                                                                    <input type="text" value="{{get_cms('section_4_sub_tittle_1','service','value')}}" name="section_4_sub_tittle_1" class="form-control"
                                                                        aria-label="Email">
                                                                        <br>
                                                                        {{-- <img src="" style="border-radius: 10px;"  width="170" height="200" alt=""> --}}
                                                                </div>
                                                                <div class="col col-12 col-md-12 col-lg-6">
                                                                    ...
                                                                    <input type="text" value="{{get_cms('section_4_sub_tittle_2','service','value')}}" name="section_4_sub_tittle_2" class="form-control"
                                                                        aria-label="Phone Number (Optional)">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="personal-informations-from-item-inner">
                                                            <div class="row ">
                                                                <div class="col col-12 col-md-12 col-lg-6">
                                                                    ...
                                                                    <input type="text" value="{{get_cms('section_4_sub_tittle_3','service','value')}}" name="section_4_sub_tittle_3" class="form-control"
                                                                        aria-label="Email">
                                                                        <br>
                                                                        {{-- <img src="" style="border-radius: 10px;"  width="170" height="200" alt=""> --}}
                                                                </div>
                                                                ...
                                                                <div class="col col-12 col-md-12 col-lg-6 ">
                                                                    <label for="exampleFormControlInput1"
                                                                        class="form-label"> Main Image</label>
                                                                    <input type="file" value="{{get_cms('section_4_main_image','service','value')}}" name="section_4_main_image" class="form-control"
                                                                        aria-label="Email"><br>
                                                                       <img src="{{asset($data['section_4_main_image']->value ?? '')}}" style="border-radius: 10px;"  width="auto" height="150" alt="">
                                                            ...
                                                            <div class="row ">
                                                                <div class="col col-12 col-md-12 col-lg-6 ">
                                                                    ...
                                                                    <input type="file" name="section_4_sub_image" class="form-control"
                                                                        aria-label="Email"><br>
                                                                       <img src="{{asset(get_cms('section_4_sub_image','service','value'))}}" style="border-radius: 10px;"  width="auto" height="150" alt="">
                                                        ...
                                                        <div class="personal-informations-from-item-inner">
                                                            <div class="row ">
                                                                <div class="col col-12 col-md-12 col-lg-6">
                                                                    ...
                                                                    <input type="text" value="{{get_cms('section_5_main_tittle','service','value')}}" name="section_5_main_tittle" class="form-control"
                                                                        aria-label="Phone Number (Optional)">
                                                                </div>
