                                    ...
                                    <div class="col-lg-12">
                                        <div class="row border border-3 border-dark m-auto py-2">
                                            <div class="personal-informations-from-btn col-lg-6 m-auto">
                                                <h2 align="left"><b>Services Faqs </b></h2>
                                            </div>
                                        ...
                                        {{-- <div class="container-fluid"> --}}
                                            <div class="card m-auto p-auto">
                                                <div class="card-header col-lg-12 d-flex justify-content-between align-items-center">
                                                    <h4 class="card-title col-lg-10">All Services Faqs</h4>
                                                    {{-- <button type="submit" ">Add Member</button> --}}
                                                    <a href="{{route('service-faqs.add')}}" class="btn-one success text-white pt-3">Add Services</a>
                                                </div>
                                                ...
                                                <table id="example" class="table table-bordered" style="width:100%" >
                                                    ...
                                                    <tbody>
                                                        @foreach ($data as $service_faqs)
                                                            <tr>
                                                                <td>{{ $service_faqs->question }}</td>
                                                                <td>{{ $service_faqs->answer }}</td>
                                                                <td>{{ $service_faqs->service_category->name }}</td>
                                                                <td class="col-lg-2">
                                                                    <div class="col-lg-12 d-flex">
                                                                    <a href="{{route('service-faqs.update', $service_faqs->id )}}" class="btn-one success text-white pt-3">Update</a><br>
                                                                    <a href="{{route('service-faqs.delete', $service_faqs->id)}}" class="btn-one danger bg-danger text-white pt-3">Delete</a>
                                                                </div></td>
                                                            </tr>
                                                        @endforeach
                                                    </tbody>
