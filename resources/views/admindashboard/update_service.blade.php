                                    ...
                                    <div class="col-lg-12">
                                        <div class="row border border-5 border-dark m-auto py-2">
                                            <div class="personal-informations-from-btn col-lg-6 m-auto">
                                                <h1 align="left"><b>Update Service</b></h1>
                                            </div>
                                        ...
                                        <form action="{{ route('service.update.store', $data->id) }}" enctype="multipart/form-data" method="POST">
                                            @csrf
                                                ...
                                                <div class="personal-informations-from-item">
                                                    ...
                                                    <div class="personal-informations-from-item-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12 col-md-12 col-lg-6">
                                                                <label for="exampleFormControlInput1"
                                                                    class="form-label last-name ">Overview</label>
                                                                <input type="text" value="{{$data->overview ?? ''}}" name="overview"
                                                                    class="form-control" aria-label="Last name">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="personal-informations-from-item-inner">
                                                        <div class="row">
                                                            <div class="col-12 col-md-12 col-lg-6">
                                                                <label for="exampleFormControlInput1"
                                                                    class="form-label last-name ">Image</label>
                                                                <input type="file" value="{{$data->image}}" name="image"
                                                                    class="form-control" aria-label="Last name"><br>
