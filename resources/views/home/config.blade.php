               ...
               <div class="row">
                  <div class="col-xl-8 col-lg-7">
                     <div class="breadcrumb__content">
                        <h3 class="breadcrumb__title tp-char-animation">Config Links Setting</h3>
                  ...
                  <div class="col-12">
                     <div class="tp-cta-bg" data-background="home/assets/img/cta/cta-bg.jpg">
                        <div class="tp-cta-content tp-inner-font text-center">
                           <h3 class="tp-section-title text-white">{{$home['section_7_main_tittle']->value}}</h3>
                           <p>{!! $home['section_7_main_desc']->value !!}</p>
