...
<!-- Mirrored from html.hixstudio.net/softec-prv/softec/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 22 Feb 2024 19:38:09 GMT -->
<head>
   <meta charset="utf-8">
   ...
   <link rel="shortcut icon" type="image/x-icon" href="{{asset(get_cms('favicon','logo-favicon' ,'value'))}}">
   ...
   <link rel="stylesheet" href="{{asset('home/assets/css/custom-animation.css')}}">
   ...
   <link rel="stylesheet" href="{{asset('home/assets/css/swiper-bundle.css')}}">
   <link rel="stylesheet" href="{{asset('home/assets/css/meanmenu.css')}}">
   <link rel="stylesheet" href="{{asset('home/assets/css/font-awesome-pro.css')}}">
               ...
               <div class="row g-0 align-items-center">
                  <div class="col-xl-2 col-lg-2 col-md-6 col-6">
                     <div class="tp-header-2__logo">
                        <a class="white-logo" href="{{route('home')}}"><img src="{{asset(get_cms('logo-white','logo-favicon' ,'value'))}}" alt=""></a>
                        <a class="black-logo" href="{{route('home')}}"><img src="{{asset(get_cms('logo-black','logo-favicon' ,'value'))}}" alt=""></a>
                     </div>
                  </div>
                           ...
                           <ul>
                            <li>
                             ...
                             <li>
                              ...
                              {{-- <li>
                                 <a href="{{route('service')}}">Portfoilo</a>
                                 <ul class="submenu">
                  ...
                  <div class="col-xl-3 col-lg-3 col-md-6 col-6">
                     <div class="tp-header-2__right d-flex align-items-center justify-content-end">
                        ...
                        <a class="tp-btn-green-sm d-none d-md-block" href="sign-in.html">Sign Up</a>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 pb-30 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".3s">
                       <div class="tp-footer__widget footer-widget-2 footer-col-2-1">
                          <div class="tp-footer__logo mb-25">
                             <a href="index.html">
                                <img src="{{asset(get_cms('logo-black','logo-favicon' ,'value'))}}" alt="">
                             </a>
                          </div>
                          <div class="tp-footer__contact-info">
                             <a href="https://www.google.com.bd/maps/place/লাক্সেমবার্গ/@49.8143242,5.5590915,10z/data=!3m1!4b1!4m5!3m4!1s0x479545b9ca212147:0x64db60f602d392ef!8m2!3d49.815273!4d6.129583"
                             ...
                             <ul>
                                <li>
                                   ...
                                   <a class="first-child" href="tel:+806(000)8899">{{ get_cms('contact_number','config' ,'value') }}</a>
                                </li>
                                <li>
                                   <span>
                                   ...
                                   <a href="mailto:contact@info.com">{{ get_cms('email_address','config' ,'value') }}</a>
                                </li>
                             </ul>
                          </div>
                       </div>
                       ...
                       <div class="tp-footer__widget footer-widget-2 footer-col-2-4">
                          ...
                          <div class="tp-footer__download-box d-flex align-items-center">
                             <div class="tp-footer__qrcode mr-15">
                               <a href="#"> <img src="{{asset('home/assets/img/footer/dwnld-1.png')}}" alt=""></a>
                             </div>
                             <div class="tp-footer__app">
                                <a href="#"><img class="mb-15" src="home/assets/img/footer/dwnld-2.png" alt=""></a>
                               <a href="#"><img src="{{asset('home/assets/img/footer/dwnld-3.png')}}" alt=""></a>
                             </div>
                          </div>
                       </div>
                    </div>
                 ...
                 <div class="row align-items-center">
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6">
                       <div class="tp-copyright__social">
                          <a href="{{ get_cms('facebook_link','config' ,'value') }}"><i class="fab fa-facebook-f"></i></a>
                          <a href="{{ get_cms('twitter_link','config' ,'value') }}"><i class="fab fa-twitter"></i></a>
                          <a href="{{ get_cms('facebook_link','config' ,'value') }}"><i class="fab fa-vimeo-v"></i></a>
                          <a href="{{ get_cms('instagram_link','config' ,'value') }}"><i class="fab fa-instagram"></i></a>
                       </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6  d-none d-md-block">
                       <div class="tp-copyright__text tp-copyright__text-2 text-center">
                          <span>{!! get_cms('copy_rigt','conig' ,'value') !!}</span>
                       </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6">
                       <div
...
<script src="{{asset('home/assets/js/magnific-popup.js')}}"></script>
<script src="{{asset('home/assets/js/counterup.js')}}"></script>
<script src="{{asset('home/assets/js/purecounter.js')}}"></script>
<script src="{{asset('home/assets/js/wow.js')}}"></script>
<script src="{{asset('home/assets/js/nice-select.js')}}"></script>
<script src="{{asset('home/assets/js/swiper-bundle.js')}}"></script>
<script src="{{asset('home/assets/js/meanmenu.js')}}"></script>
<script src="{{asset('home/assets/js/tilt.jquery.js')}}"></script>
<script src="{{asset('home/assets/js/isotope-pkgd.js')}}"></script>
<script src="{{asset('home/assets/js/imagesloaded-pkgd.js')}}"></script>
<script src="{{asset('home/assets/js/ajax-form.js')}}"></script>
<script src="{{asset('home/assets/js/gsap.min.js')}}"></script>
<script src="{{asset('home/assets/js/ScrollTrigger.min.js')}}"></script>
<script src="{{asset('home/assets/js/ScrollSmoother.min.js')}}"></script>
<script src="{{asset('home/assets/js/split-text.min.js')}}"></script>
<script src="{{asset('home/assets/js/parallax-scroll.js')}}"></script>
...
<!-- Mirrored from html.hixstudio.net/softec-prv/softec/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 22 Feb 2024 19:38:43 GMT -->
</html>
