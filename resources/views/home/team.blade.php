                  ...
                  <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-70 tp-border-after-1 team-inner-border-right">
                     <div class="tp-team-item text-center tp-team-inner-title-color z-index">
                        ...
                        <div class="tp-team-social">
                           <a class="icon-color-1" href="{{get_cms('facebook_link','config','value')}}">
                              <i class="fab fa-facebook-f"></i>
                              <span></span>
                           </a>
                           <a class="icon-color-2" href="{{get_cms('instagram_link','config','value')}}">
                              <i class="fab fa-instagram"></i>
                              <span></span>
                           </a>
                           <a class="icon-color-3" href="{{get_cms('twitter_link','config','value')}}">
                              <i class="fab fa-twitter"></i>
                              <span></span>
                           </a>
                           <a class="icon-color-4" href="{{get_cms('linkedin_link','config','value')}}">
                ...
                @endforeach
                  ...
                  {{-- <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-70 tp-border-after-2 team-inner-border-right">
                     <div class="tp-team-item tp-team-inner-title-color text-center z-index">
                        <div class="tp-team-img">
                           <img src="home/assets/img/team/team-4-2.png" alt="">
                        </div>
                        <div class="tp-team-content">
                  ...
                  <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-70 tp-border-after-3 team-inner-border-right">
                     <div class="tp-team-item tp-team-inner-title-color text-center z-index">
                        <div class="tp-team-img">
                           <img src="home/assets/img/team/team-4-3.png" alt="">
                        </div>
                        <div class="tp-team-content">
                  ...
                  <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-70 tp-border-after-4 team-inner-border-right">
                     <div class="tp-team-item tp-team-inner-title-color text-center z-index">
                        <div class="tp-team-img">
                           <img src="home/assets/img/team/team-4-4.png" alt="">
                        </div>
                        <div class="tp-team-content">
                           <h4 class="tp-team-title-sm"><a href="team-details.html">Imdat Cimsit</a></h4>
                  ...
                  <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-70 tp-border-after-1 team-inner-border-right">
                     <div class="tp-team-item tp-team-inner-title-color text-center z-index">
                        <div class="tp-team-img">
                           <img src="home/assets/img/team/team-4-5.png" alt="">
                        </div>
                        <div class="tp-team-content">
                  ...
                  <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-70 tp-border-after-2 team-inner-border-right">
                     <div class="tp-team-item tp-team-inner-title-color text-center z-index">
                        <div class="tp-team-img">
                           <img src="home/assets/img/team/team-4-6.png" alt="">
                        </div>
                        <div class="tp-team-content">
                  ...
                  <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-70 tp-border-after-3 team-inner-border-right">
                     <div class="tp-team-item tp-team-inner-title-color text-center z-index">
                        <div class="tp-team-img">
                           <img src="home/assets/img/team/team-4-7.png" alt="">
                        </div>
                        <div class="tp-team-content">
                  ...
                  <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-70 tp-border-after-4 team-inner-border-right">
                     <div class="tp-team-item tp-team-inner-title-color text-center z-index">
                        <div class="tp-team-img">
                           <img src="home/assets/img/team/team-4-8.png" alt="">
                        </div>
                        <div class="tp-team-content">
                           <h4 class="tp-team-title-sm"><a href="team-details.html">Imdat Cimsit</a></h4>
                           <span>Marketing Lead</span>
