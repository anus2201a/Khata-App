   ...
   <div class="tpoffcanvas-area">
      <div class="tpoffcanvas">
         ...
         <div class="tpoffcanvas__logo text-center">
            <a href="index.html">
               <img src="home/assets/img/logo/logo-white.png" alt="">
            </a>
         </div>
         ...
         <div class="tpoffcanvas__instagram text-center">
            ...
            <a href="#"><img src="home/assets/img/project/project-inner-4.jpg" alt=""></a>
            <a href="#"><img src="home/assets/img/project/project-inner-5.jpg" alt=""></a>
            <a href="#"><img src="home/assets/img/project/project-inner-6.jpg" alt=""></a>
            <a href="#"><img src="home/assets/img/project/project-inner-7.jpg" alt=""></a>
         </div>
      ...
      <div id="smooth-content">
         ...
         <main class="fix">
            ...
            <div class="tp-hero-2__area tp-hero-2__ptb tp-hero-2__plr z-index fix p-relative"
               data-background="{{asset(get_cms('section_1_bg_image','home','value'))}}">
               <div class="scroll-bg d-none d-sm-block">
                  <img src="home/assets/img/hero/scroll-down.png" alt="">
               </div>
                  ...
                  <div class="row g-0 align-items-end">
                     <div class="col-xl-6 col-lg-6">
                        <div class="tp-hero-2__title-box">
                           <h3 class="tp-hero-2__title tp-char-animation">{{get_cms('section_1_main_tittle','home','value')}}</h3>
                        </div>
                        <div class="tp-hero-2__btn">
                           <a class="tp-btn-green wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".5s"
                              href="service-details.html">Get Started For Free</a>
                        </div>
                        <div class="tp-hero-2__user p-relative">
                           ...
                           <div class="tp-hero-2__user-img">
                              <img src="home/assets/img/hero/hero-user.jpg" alt="">
                           </div>
                  ...
                  <div class="row justify-content-center">
                     <div class="col-xl-7">
                        <div class="tp-payment__title-box text-center mb-55">
                           <h3 class="tp-section-title-lg">{!! get_cms('section_2_main_tittle','home','value') !!} </h3>
                           <p>{{get_cms('section_2_main_decs','home','value')}}</p>
                        </div>
                     </div>
                  </div>
                  <div class="row justify-content-center">
                           ...
                           <div class="col-md-6 mb-30">
                              <div class="tp-payment__item tp-payment__bg-color-2 p-relative z-index wow tpfadeLeft" data-wow-duration=".9s" data-wow-delay=".3s">
                                 <div class="tp-payment__shape-4">
                                    <img src="home/assets/img/payment/qrcode.png" alt="">
                                 </div>
                                 <div class="tp-payment__shape-5">
                                    <img src="{{asset(get_cms('section_2_image_1','home','value'))}}" alt="">
                                 </div>
                                 <div class="tp-payment__shape-6">
                                    <img src="home/assets/img/payment/hand.png" alt="">
                                 </div>
                                 <div class="tp-payment__shape-7">
                                    <img src="home/assets/img/payment/coin-1.png" alt="">
                                 </div>
                                 <div class="tp-payment__shape-8">
                                    <img src="home/assets/img/payment/coin-2.png" alt="">
                                 </div>
                                 <div class="tp-payment__content">
                                    <h3 class="tp-payment__title">{{get_cms('section_2_tittle_1','home','value')}}</h3>
                                    <p>{!!get_cms('section_2_desc_1','home','value')!!}
                                    </p>
                                 </div>
                              </div>
                           </div>
                           <div class="col-md-6 mb-30">
                              <div class="tp-payment__item tp-payment__bg-color-3 p-relative z-index wow tpfadeRight" data-wow-duration=".9s" data-wow-delay=".5s">
                                 <div class="tp-payment__shape-9">
                                    <img src="home/assets/img/payment/payment-3.png" alt="">
                                 </div>
                                 <div class="tp-payment__shape-11">
                                    <img src="{{asset(get_cms('section_2_image_2','home','value'))}}" alt="">
                                 </div>
                                 <div class="tp-payment__content">
                                    <h3 class="tp-payment__title">{{get_cms('section_2_tittle_2','home','value')}}</h3>
                                    <p>{{get_cms('section_2_desc_2','home','value')}}</p>
                                 </div>
                              </div>
                           </div>
                        </div>
                     ...
                     <div class="col-xl-12 mb-30">
                        <div class="tp-payment__item p-relative z-index wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".7s">
                           <div class="tp-payment__shape-1">
                              <img src="home/assets/img/payment/background.png" alt="">
                           </div>
                           <div class="row">
                              <div class="col-md-6">
                                 <div class="tp-payment__content tp-payment__content-space">
                                    <h3 class="tp-payment__title">{!! get_cms('section_2_tittle_3','home','value')!!}</h3>
                                    <p>{!!get_cms('section_2_desc_3','home','value')!!}</p>
                                    <a href="service-details.html">Explore Invoicing Tools<i class="far fa-arrow-right"></i></a>
                                 </div>
                              </div>
                              <div class="col-md-6">
                                 <div class="tp-payment__shape-2">
                                    <img src="{{asset(get_cms('section_2_image_3','home','value'))}}" alt="">
                                 </div>
                                 <div class="tp-payment__shape-3 d-none d-sm-block">
                                    <img src="home/assets/img/payment/get-paid.png" alt="">
                                 </div>
                              </div>
                           </div>
                        </div>
                  ...
                  <div class="row g-0 justify-content-center">
                     <div class="col-xl-7">
                        <div class="tp-payment-method__title-box text-center mb-20">
                           <h3 class="tp-section-title-lg pb-10">{!! get_cms('section_3_main_tittle','home','value') !!}</h3>
                           <p>{{get_cms('section_3_main_desc','home','value')}}</p>
                        </div>
                     </div>
                  </div>
                  <div class="row g-0">
            ...
            <div class="tp-service-2__area p-relative pt-70 pb-160">
               <div class="tp-service-2__shape">
                  <img src="home/assets/img/service/sv-bg-2-1.jpg" alt="">
               </div>
               <div class="container z-index-5">
                  <div class="row align-items-center mb-50">
                     <div class="col-xl-6 col-lg-6">
                        <div class="tp-service-2__section-box">
                           <h3 class="tp-section-title-lg pb-20">{!!get_cms('section_4_main_tittle','home','value')  !!}</h3>
                              {{-- pending --}}
                           <p>{{get_cms('section_4_main_desc','home','value')}}</p>
                        </div>
                     </div>
                  ...
                  <div class="row gx-60">
                        ...
                        <div class="tp-service-2__item-wrapper p-relative">
                           <div class="tp-service-2__item d-flex justify-content-between flex-column">
                              <div class="tp-service-2__icon">
                                 <img src="home/assets/img/service/sv-icon-2-1.png" alt="">
                              </div>
                     ...
                     <div class="col-xl-3 col-lg-3 col-md-6 mb-40 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".6s">
                        <div class="tp-service-2__item-wrapper p-relative">
                           <div class="tp-service-2__item d-flex justify-content-between flex-column">
                              <div class="tp-service-2__icon">
                                 <img src="home/assets/img/service/sv-icon-2-2.png" alt="">
                              </div>
                              <div class="tp-service-2__text">
                     ...
                     <div class="col-xl-3 col-lg-3 col-md-6 mb-40 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".8s">
                        <div class="tp-service-2__item-wrapper p-relative">
                           <div class="tp-service-2__item d-flex justify-content-between flex-column">
                              <div class="tp-service-2__icon">
                                 <img src="home/assets/img/service/sv-icon-2-3.png" alt="">
                              </div>
                              <div class="tp-service-2__text">
                     ...
                     <div class="col-xl-3 col-lg-3 col-md-6 mb-40 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".9s">
                        <div class="tp-service-2__item-wrapper p-relative">
                           <div class="tp-service-2__item  d-flex justify-content-between flex-column">
                              <div class="tp-service-2__icon">
                                 <img src="home/assets/img/service/sv-icon-2-4.png" alt="">
                              </div>
                              <div class="tp-service-2__text">
                     ...
                     <div class="col-xl-10 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".9s">
                        <div class="tp-service-2__bottom-wrapper p-relative mt-30">
                           <div class="tp-service-2__feature-item">
                              <h4 class="tp-service-2__feature-title">{{get_cms('section_4_tittle_1','home','value')}}</h4>
                     ...
                     <div class="col-xl-6 col-lg-6">
                        <div class="tp-account-thumb-wrapper p-relative text-center wow tpfadeLeft" data-wow-duration=".9s" data-wow-delay=".5s">
                           <div class="tp-account-bg">
                              <img src="home/assets/img/account/account-bg.png" alt="">
                           </div>
                           <div class="tp-account-main-img">
                              <img src="{{asset(get_cms('section_5_front_image','home','value'))}}" alt="">
                           </div>
                           <div class="tp-account-author">
                              <img src="{{asset(get_cms('section_5_bg_image','home','value'))}}" alt="">
                           </div>
                           <div class="tp-account-shape-1">
                              <img src="home/assets/img/account/ac-shape-1.png" alt="">
                           </div>
                           <div class="tp-account-shape-2">
                              <img src="home/assets/img/account/ac-shape-2.png" alt="">
                           </div>
                        </div>
                     </div>
                     <div class="col-xl-6 col-lg-6">
                        <div class="tp-account-step-wrapper">
                           <div class="tp-account-section-box mb-40">
                              ...
                              <h3 class="tp-section-title-lg">{{get_cms('section_5_main_tittle','home','value')}}</h3>
                           </div>
                           <div class="tp-account-step mb-50">
                              <div class="tp-account-item d-flex align-items-center">
                                 <span>01</span>
                                 <p>{{get_cms('section_5_sub_tittle_1','home','value')}}</p>
                              </div>
                              <div class="tp-account-item d-flex align-items-center">
                                 <span>02</span>
                                 <p>{{get_cms('section_5_sub_tittle_2','home','value')}}</p>
                              </div>
                              <div class="tp-account-item d-flex align-items-center">
                                 <span>03</span>
                                 <p>{!! get_cms('section_5_sub_tittle_3','home','value') !!}</p>
                              </div>
                           </div>
            ...
            <div class="tp-testimonial-2-area pt-110 pb-120" data-background="home/assets/img/testimonial/testi-bg-2-1.png">
               <div class="container">
                  <div class="row justify-content-center">
                     <div class="col-xl-8">
                           ...
                           <div class="tp-testimonial-2-slider-active">
                              <div>
                                 <div class="tp-testimonial-2-item p-relative wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".3s">
                                    <div class="tp-testimonial-2-border-shape">
                                       <img src="home/assets/img/testimonial/BODY.png" alt="">
                                    </div>
                                    ...
                                    <div class="tp-testimonial-2-author d-flex align-items-center">
                                       <div class="tp-testimonial-2-img">
                                          <img src="home/assets/img/testimonial/testi-icon-2-1.png" alt="">
                                       </div>
                              ...
                              <div>
                                 <div class="tp-testimonial-2-item p-relative wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".5s">
                                    ...
                                    <div class="tp-testimonial-2-author d-flex align-items-center">
                                       <div class="tp-testimonial-2-img">
                                          <img src="home/assets/img/testimonial/testi-icon-2-2.png" alt="">
                                       </div>
                                       <div class="tp-testimonial-2-author-info">
                                          <h5>J. McGhee</h5>
                                          <span>Founder & Leader</span>
                              ...
                              <div>
                                 <div class="tp-testimonial-2-item p-relative wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".7s">
                                    ...
                                    <div class="tp-testimonial-2-author d-flex align-items-center">
                                       <div class="tp-testimonial-2-img">
                                          <img src="home/assets/img/testimonial/testi-icon-2-3.png" alt="">
                                       </div>
                                       <div class="tp-testimonial-2-author-info">
                                          <h5>Michael H.</h5>
                                          <span>Founder & Leader</span>
                     ...
                     <div class="col-xl-6 col-lg-6">
                        <div class="tp-faq-left-wrapper p-relative">
                           <div class="tp-faq-section-box pb-20">
                              ...
                              <h3 class="tp-section-title-lg">{!! get_cms('section_6_main_tittle','home','value') !!} </h3>
                           ...
                           <div class="tp-faq-img" data-parallax='{"x": -50, "smoothness": 30}'>
                              <img src="{{asset(get_cms('section_6_image','home','value'))}}" alt="">
                           </div>
                        </div>
                     </div>
                     <div class="col-xl-6 col-lg-6">
                              ...
                              <div class="accordion-items">
                                 <h2 class="accordion-header" id="headingFive">
                                    <button class="accordion-buttons collapsed" type="button" data-bs-toggle="collapse"
                                       ...
                                       aria-controls="collapseFive"> {{get_cms('section_6_sub_tittle_5','home','value')}}
                                       <span class="accordion-btn"></span>
                                    </button>
                                 </h2>
                     ...
                     <div class="col-12">
                        <div class="tp-cta-bg" data-background="home/assets/img/cta/cta-bg.jpg">
                           <div class="tp-cta-content text-center">
                              <h3 class="tp-section-title-lg text-white">{{get_cms('section_7_main_tittle','home','value')}}</h3>
