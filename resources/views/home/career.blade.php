                            ...
                            <div class="row justify-content-center">
                                <div class="col-xl-12">
                                    <div class="breadcrumb__content text-center z-index-3 mb-60">
                                        <h3 class="breadcrumb__title">{!! get_cms('section_1_main_tittle','career','value')!!}</h3>
                                        <div class="breadcrumb__text">
                                            <p>{{get_cms('section_1_main_desc','career','value') ?? 'Work without distraction on your own or with your team.'}}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-xl-3 col-lg-3 col-md-6">
                                <div class="carrer-banner-img-item">
                                    <img src="{{asset(get_cms('section_1_image_1','career','value'))}}" alt="">
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6">
                                <div class="carrer-banner-img-item parallax-main">
                                    <img class="parallax-img" src="{{asset(get_cms('section_1_image_2','career','value'))}}" alt=""
                                        data-parallax='{"y": 300, "smoothness": 10}'>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-3 d-none d-lg-block">
                                <div class="carrer-banner-img-item mb-20">
                                    <img src="{{asset(get_cms('section_1_image_3','career','value'))}}" alt="">
                                </div>
                                <div class="carrer-banner-img-item">
                                    <img src="{{asset(get_cms('section_1_image_4','career','value'))}}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row align-items-end mb-60">
                            <div class="col-xl-7 col-lg-6 wow tpfadeLeft" data-wow-duration=".9s" data-wow-delay=".3s">
                                <div class="tp-platform-section-box">
                                    ...
                                    <h3 class="tp-section-title">{{get_cms('section_2_main_tittle','career','value') ?? 'Our Platform'}}</h3>
                                </div>
                            </div>
                            <div class="col-xl-5 col-lg-6  wow tpfadeRight" data-wow-duration=".9s" data-wow-delay=".5s">
                                <div class="tp-platform-text">
                                    <p>{!! get_cms('section_2_main_decs','career','value') ?? 'Explore how Avalance can help you toassess security <br>
                        ...
                        <div class="row align-items-center">
                            <div class="col-xl-2 col-lg-2 d-none d-xl-block">
                                <div class="tp-platform-img-box">
                                    <img src="{{asset(get_cms('section_2_image_1','career','value'))}}" alt="">
                                </div>
                            </div>
                                        ...
                                        <div class="col-custom">
                                                <div class="tp-panel-item">
                                                    <div class="tp-panel-content">
                                                        <span>  <span>0{{ $platform->id}}.</span></span>
                                                ...
                                                <div class="tp-panel-item-2">
                                                    <div class="tp-panel-content-2">
                                                        <span>01.</span>
                                                        <h4 class="tp-panel-title-2">{{ $platform->name }}</h4>
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="job-section-box text-center mb-40">
                                    <h3 class="tp-section-title">{{get_cms('section_3_main_tittle','career','value') }}</h3>
                                    <p>{!!get_cms('section_3_main_desc','career','value') !!}</p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-lg-3 col-md-3">
                                    <div class="job-post-apply-btn text-start text-md-end">
                                        <a class="tp-btn-inner tp-btn-hover alt-color-orange"
                                            href="career-details.html"><span>Apply</span> <b></b></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="job-post-time d-flex align-items-center">
                                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                                ...
                                                <path
                                                    ...
                                                    stroke="#5F6168" stroke-width="1.5" stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                                <path d="M9 5.7998V9.9998L11.8 11.3998" stroke="#5F6168"
