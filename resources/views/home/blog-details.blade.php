                  ...
                  <div class="col-xl-9 col-lg-9 col-md-9">
                     <div class="blog-details-banner z-index-2">
                        <div class="blog-details-title-box">
                           <span>Resources</span>
                           <h3 class="blog-details-banner-title">{!!$data->tittle!!}</h3>
                        </div>
                        <div class="tp-blog-author-info-box d-flex align-items-center">
                           <div class="tp-blog-avata">
                              <img src="{{asset('home/assets/img/blog/blog-avata-1.png')}}" alt="">
                           </div>
               ...
               <div class="row">
                  <div class="col-xl-12">
                     <div class="blog-details-big-img z-index-2">
                        <img src="{{asset($data->image ?? 'home/assets/img/blog/blog-details-1.jpg')}}" alt="">
                     </div>
                  </div>
               </div>
            </div>
                        ...
                        <article>
                           ...
                           <div class="postbox__details-img-box d-flex">
                              <div class="mr-20 text-center">
                                 <img class="mb-20" src="{{asset('home/assets/img/blog/blog-details-2.jpg')}}" alt="">
                                 <h4 class="postbox__details-img-caption"><span>Images by</span>@sample</h4>
                              </div>
                              <div class="text-center">
                                 <img class="mb-20" src="{{asset('home/assets/img/blog/blog-details-3.jpg')}}" alt="">
                           ...
                           <div class="postbox__navigation-more mb-70 d-flex justify-content-between">
                              <div class="postbox__navigation-left d-flex align-items-center">
                                 <div class="postbox__navigation-img">
                                    <a href="#"><img src="{{asset('home/assets/img/blog/navigation-1.png')}}" alt=""></a>
                                 </div>
                              ...
                              <div class="postbox__navigation-right d-flex align-items-center">
                                 ...
                                 <div class="postbox__navigation-img">
                                    <a href="#"><img src="{{asset('home/assets/img/blog/navigation-2.png')}}" alt=""></a>
                                 </div>
                              </div>
                           </div>
                           <div class="postbox__details-author-info-box mb-100 d-flex align-items-start">
                              <div class="postbox__details-author-avata">
                                 <img src="{{asset('home/assets/img/blog/blog-details-avata-1.jpg')}}" alt="">
                              </div>
                              ...
                              <ul>
                                    ...
                                    <div class="postbox__comment-box d-flex">
                                       <div class="postbox__comment-info ">
                                          <div class="postbox__comment-avater mr-20">
                                             <img src="{{asset('home/assets/img/blog/blog-avata-2.png')}}" alt="">
                                          </div>
                                       </div>
                                 ...
                                 <li>
                                    <div class="postbox__comment-box d-flex">
                                       <div class="postbox__comment-info ">
                                          <div class="postbox__comment-avater mr-20">
                                             <img src="{{asset('home/assets/img/blog/blog-list-avata-1.jpg')}}" alt="">
                                          </div>
                                       </div>
                                       <div class="postbox__comment-text">
                                          <div class="postbox__comment-name d-flex">
                              ...
                              <div class="sidebar__post rc__post">
                                 <div class="rc__post mb-20 d-flex">
                                    <div class="rc__post-thumb mr-20">
                                       <a href="blog-details.html"><img src="{{asset('home/assets/img/blog/blog-list-avata-1.jpg')}}" alt=""></a>
                                    </div>
                                 ...
                                 <div class="rc__post mb-20 d-flex">
                                    <div class="rc__post-thumb mr-20">
                                       <a href="blog-details.html"><img src="{{asset('home/assets/img/blog/blog-list-avata-2.jpg')}}" alt=""></a>
                                    </div>
                                    <div class="rc__post-content">
                                       <h3 class="rc__post-title">
                                          <a href="blog-details.html">Is slower team communication a bad thing?</a>
                                 ...
                                 <div class="rc__post d-flex">
                                    <div class="rc__post-thumb mr-20">
                                       <a href="blog-details.html"><img src="{{asset('home/assets/img/blog/blog-list-avata-3.jpg')}}" alt=""></a>
                                    </div>
                                    <div class="rc__post-content">
                                       <h3 class="rc__post-title">
                     ...
                     <div class="blog-details-slider-wrapper">
                        <div class="swiper-container blog-slider-active pb-50">
                           ...
                           <div class="swiper-slide">
                                 <div class="tp-blog-item">
                                    <div class="tp-blog-thumb fix">
                                       <a href="#"><img src="{{asset('home/assets/img/blog/blog-grid-1.jpg')}}" alt=""></a>
                                    </div>
                           ...
                           <div class="swiper-slide">
                                 <div class="tp-blog-item">
                                    <div class="tp-blog-thumb fix">
                                       <a href="#"><img src="{{asset('home/assets/img/blog/blog-grid-2.jpg')}}" alt=""></a>
                                    </div>
                                    <div class="tp-blog-content">
                                       <div class="tp-blog-meta d-flex align-items-center">
                                          <div class="tp-blog-category category-color-1">
                           ...
                           <div class="swiper-slide">
                                 <div class="tp-blog-item">
                                    <div class="tp-blog-thumb fix">
                                       <a href="#"><img src="{{asset('home/assets/img/blog/blog-grid-3.jpg')}}" alt=""></a>
                                    </div>
                                    <div class="tp-blog-content">
                                       <div class="tp-blog-meta d-flex align-items-center">
                                          <div class="tp-blog-category category-color-1">
                                       ...
                                       <div class="tp-blog-author-info-box d-flex align-items-center">
                                          <div class="tp-blog-avata">
                                             <img src="{{asset('home/assets/img/blog/blog-avata-3.png')}}" alt="">
                                          </div>
                                          <div class="tp-blog-author-info">
                                             <h5>Hilary Ouse</h5>
                                             <span>Founder & CEO Dulalix</span>
