                  ...
                  <div class="row">
                     ...
                     <div class="col-xl-3 col-lg-5 col-lg-4 text-center text-md-end">
                        <div class="breadcrumb__img p-relative text-start z-index">
                           <img class="z-index-3" src="home/assets/img/breadcrumb/breadcrumb-3.png" alt="">
                           <div class="breadcrumb__sub-img wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".4s">
                              <img src="home/assets/img/breadcrumb/breadcrumb-sub-1.png" alt="">
                           </div>
                        </div>
                     </div>
                  </div>
                           ...
                           <div class="swiper-container blog-grid-slider-active">
                              <div class="swiper-wrapper">
                                 ...
                                 <div class="swiper-slide">
                                    <div class="blog-grid-slider blog-grid-slider-bg d-flex align-items-center blog-grid-slider-height" data-background="{{asset($blog->image ?? 'home/assets/img/blog/inner-blog-1.png')}}">
                                       <div class="blog-grid-slider-wrapper">
                                          ...
                                          <div class="blog-grid-slider-title-box">
                                             <h4 class="blog-grid-slider-title"><a href="{{ route('blog.details', $blog->id)}}">{!! $blog->tittle ?? '5 Companies doing Brand <br> Marketing Right'!!}</a></h4>
                                             <p>{!! $blog->description ?? 'From publishing content and hoping to acquire leads to <br>
                                          ...
                                          <div class="tp-blog-author-info-box blog-grid-avata-box d-flex align-items-center">
                                             <div class="tp-blog-avata">
                                                <img src="home/assets/img/blog/blog-avata-3.png" alt="">
                                             </div>
                                 ...
                                 @endforeach
                                 {{-- <div class="swiper-slide">
                                    <div class="blog-grid-slider blog-grid-slider-bg d-flex align-items-center blog-grid-slider-height" data-background="home/assets/img/blog/inner-blog-2.png">
                                       <div class="blog-grid-slider-wrapper">
                                          <div class="blog-grid-slider-meta">
                                             <span class="child-one">Resources</span>
                                             <span class="child-two">October 20, 2023</span>
                                          ...
                                          <div class="tp-blog-author-info-box blog-grid-avata-box d-flex align-items-center">
                                             <div class="tp-blog-avata">
                                                <img src="home/assets/img/blog/blog-avata-2.png" alt="">
                                             </div>
                                             <div class="tp-blog-author-info">
                                                <h5>Hilary Ouse</h5>
                                                <span>Founder & CEO Dulalix</span>
                                 ...
                                 <div class="swiper-slide">
                                    <div class="blog-grid-slider blog-grid-slider-bg d-flex align-items-center blog-grid-slider-height" data-background="home/assets/img/blog/inner-blog-3.png">
                                       <div class="blog-grid-slider-wrapper">
                                          <div class="blog-grid-slider-meta">
                                             <span class="child-one">Resources</span>
                                             <span class="child-two">October 20, 2023</span>
                                          ...
                                          <div class="tp-blog-author-info-box blog-grid-avata-box d-flex align-items-center">
                                             <div class="tp-blog-avata">
                                                <img src="home/assets/img/blog/blog-avata-1.png" alt="">
                                             </div>
                                             <div class="tp-blog-author-info">
                                                <h5>Hilary Ouse</h5>
                                                <span>Founder & CEO Dulalix</span>
                     ...
                     <div class="col-xl-4 col-lg-6 col-md-6 mb-30 grid-item cat1 cat4 cat3 cat5">
                        <div class="tp-blog-item">
                           <div class="tp-blog-thumb fix">
                              <a href="blog-details.html"><img src="{{asset($blog->image ?? 'home/assets/img/blog/inner-blog-1.png')}}" alt=""></a>
                           </div>
                           <div class="tp-blog-content">
                              ...
                              <div class="tp-blog-title-box">
                                 <a class="tp-blog-title-sm" href="blog-details.html">{!! $blog->tittle ?? '2023 Professional Year In <br> Review'!!}</a>
                              </div>
                              <div class="tp-blog-author-info-box d-flex align-items-center">
                                 <div class="tp-blog-avata">
                                    <img src="home/assets/img/avata/avata-1.png" alt="">
                                 </div>
                                 <div class="tp-blog-author-info">
                                    <h5>Hilary Ouse</h5>
                                    <span>Founder & CEO Dulalix</span>
